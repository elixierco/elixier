...
{{ define "ranger-install-properties" }}
...
db_name=ranger
db_user=rangeradmin
db_password={{ .Values.ranger.db_password }}
...
rangerAdmin_password={{ .Values.ranger.admin_password }}
rangerTagsync_password={{ .Values.ranger.admin_password }}
rangerUsersync_password={{ .Values.ranger.admin_password }}
keyadmin_password={{ .Values.ranger.admin_password }}
...
policymgr_external_url=http://ranger.{{ .Values.ingress.domain }}
