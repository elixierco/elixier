...
<property>
    ...
    <property>
        ...
        <value>{{ .Values.global.ranger.opensearch.user }}</value>
    </property>
    <property>
        <name>xasecure.audit.destination.elasticsearch.password</name>
        <value>{{ .Values.global.ranger.opensearch.password }}</value>
    </property>
    <property>
        <name>xasecure.audit.destination.elasticsearch.index</name>
        <value>{{ .Values.global.ranger.opensearch.index | default "ranger_audit" }}</value>
    </property>
    <property>
        <name>xasecure.audit.destination.elasticsearch.port</name>
        <value>{{ .Values.global.ranger.opensearch.port | default "9200" }}</value>
    </property>
    <property>
        <name>xasecure.audit.destination.elasticsearch.protocol</name>
        <value>{{ .Values.global.ranger.opensearch.proto | default "http" }}</value>
    </property>
    <property>
