...
SPARK_HADOOP_CLOUD_JAR=spark-hadoop-cloud_2.12-${HADOOP_VERSION}.jar
...
download https://repo1.maven.org/maven2/org/apache/spark/spark-hadoop-cloud_2.12/${HADOOP_VERSION}/${SPARK_HADOOP_CLOUD_JAR} ${SPARK_JAR_DIR}/${SPARK_HADOOP_CLOUD_JAR}
